...
class ActiveJobExtTest < ActiveSupport::TestCase
  ...
  test "record" do
    ...
    key = "active_job|queue|default|worker|SimpleWorker|jid|7d48fbf20976c224510dbc60|datetime|1583146613|datetimei|1583146614|enqueued_ati|1583146615|start_timei|1583146616|status|success|END|#{RailsPerformance::SCHEMA}"
